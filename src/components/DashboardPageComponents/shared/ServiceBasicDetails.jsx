...
const ServiceBasicDetails = ({activeKey, handleCollapseChange, isStepComplete, handleSubmit, onSubmit, image, thumbnailName, handleFileChange, register, control, croppedImage, handleRemoveImage, setIsModalOpen}) => {
    return (
        <div>
            <Collapse
