...
const testimonials = [
  {
    ...
    time: "16:23",
    avatar: "",
    images: [testimonial1, testimonial2],
    description:
      ...
      <div className=" space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between space-y-2">
          <h2 className="text-2xl font-semibold">
            <Translator text={"What Our Clients Say"} />
          </h2>
          <a href="#" className="text-sm flex items-center gap-1">
            <span className=" font-semibold">⭐ 4.8</span>
            <span className="hover:underline text-description">
              <Translator text={"(12.5K reviews)"} />
            </span>
          </a>
        </div>
        ...
        {visibleCount < testimonials.length && (
          <div>
            <button
              ...
              className="text-sm text-primary01 font-semibold cursor-pointer flex items-center mb-32">
              <Translator text={"View More"} />
              <span className="ml-1">
