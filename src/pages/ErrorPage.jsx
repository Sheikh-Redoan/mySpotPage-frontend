  ...
  return (
    <div className="min-h-screen bg-highlight01 flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
      ...
      <h2 className="text-3xl font-extrabold text-black mt-2">
        <Translator text={"Page Not Found"} />
      </h2>
      ...
      <div className="flex gap-4 mt-8 flex-wrap justify-center">
        <button
          ...
          <span
            className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-primary01 rounded-lg group-hover:mb-0 group-hover:mr-0"
            data-rounded="rounded-lg"></span>
        </button>
        <Link
          to="/"
      ...
      <div className="absolute bottom-4 left-4 rotate-[-6deg]">
        <span className="inline-block bg-red-500 text-white px-3 py-1 rounded-md font-bold shadow-lg border-primary01 border-2">
          <Translator text={"Error Code: LOST_IN_SPACE"} />
        </span>
      </div>
      ...
      />
      <AlertTriangle
        className="absolute top-[40%] right-5 md:right-10 text-primary01 opacity-40"
        size={32}
      />
