...
const BookingsDetailsOfEachStatus = () => {
  ...
  const [selectedDate, setSelectedDate] = useState(
    booking ? new Date(booking.scheduledDate.split("/").reverse().join("-")) : new Date()
  );
  ...
  // Format the date for display (e.g., "Sun, 06 Jan 2025")
    ...
    <div className="w-full flex flex-col lg:flex-row p-4 gap-4">
      ...
      <div className="flex-1 bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-600">{booking.notes || "No notes available"}</p>
        </div>
