    ...
    <div className="w-full p-5">
      <div className="flex items-center justify-between ">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            className="inline-flex items-center px-3 py-2 gap-2 text-sm font-semibold border border-[#242528] rounded-lg focus:ring-2 focus:ring-[#242528] focus:ring-offset-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
